...
public class RtmpPlayActivity extends Activity implements NodePlayerDelegate {
    ...
    // 播放对象
    public NodePlayer mNodePlayer = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 获取对象
        String streamId = getIntent().getStringExtra("stream");
        String dstIp = getIntent().getStringExtra("dstIp");
        String dstPort = getIntent().getStringExtra("dstPort");
    ...
    public void onEventCallback(NodePlayer arg0, int arg1, String arg2) {
        Log.e(TAG, "onEventCallback:" + arg1 + " msg:" + arg2);
        switch (arg1) {
            case 1000:
                // 正在连接视频
                break;
